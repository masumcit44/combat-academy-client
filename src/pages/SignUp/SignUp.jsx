        ...
        <div className="card flex-shrink-0 w-full max-w-sm shadow-2xl bg-base-100">
          <form onSubmit={handleSubmit(onSubmit)} className="card-body">
            ...
            <div className="form-control">
              ...
              />
              <button type="button"  onClick={()=>setShowPass(!showPass)} className="btn btn-sm btn-circle text-lime-500 absolute end-2  ">
                <FaEye></FaEye>
              </button>
              </div>
            ...
            <div className="form-control">
              ...
              />
              <button type="button"  onClick={()=>setShowConfirmPass(!showConfirmPass)} className="btn btn-sm btn-circle text-lime-500 absolute end-2  ">
                <FaEye></FaEye>
              </button>
              </div>
              <label className="label">
